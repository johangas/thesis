...
do_install() {
	install -m 0755 -d	${D}${INSTALL_ROOT} \
				...
				${D}${SBINDIR}/www \
				${D}${SBINDIR}/6lbr \
				${D}${SBINDIR}/6lbr/ifup.d \
				${D}${SBINDIR}/6lbr/ifdown.d \
	...
	install -m 0644 ${S}${NBRDIR}/www/*			${D}${SBINDIR}/www
	install -m 0644 ${S}${NBRDIR}/6lbr/6lbr.conf		${D}${SBINDIR}/6lbr
	install -m 0774 ${S}${NBRDIR}/6lbr/*-*			${D}${SBINDIR}/6lbr
	install -m 0774 ${S}${NBRDIR}/6lbr/ifup.d/*		${D}${SBINDIR}/6lbr/ifup.d
	install -m 0774 ${S}${NBRDIR}/6lbr/ifdown.d/*		${D}${SBINDIR}/6lbr/ifdown.d
