...
\subsection{DTLS}
The transport layer security (TLS) originated DTLS (Datagram TLS) protocol allows client/server applications to communicate in a way that is designed to prevent eavesdropping, tampering, or message forgery. \cite{dtls} The protocol assures equivalent securiy guarantees. DTLS must be run over a reliable transport channel such as TCP. The protocol can thus not be used to secure unreliable datagram traffic.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Thanks to Bober, Wojciech at Nordic Semiconductor, author of the nRF52dk-pr contiki port, for his support
